#!/bin/bash
#
# Continue Full Analysis from Step 3 (Seed-Based Connectivity) - PARALLEL VERSION
# Steps 1-2 (Metadata, Local Measures) already completed
#
# This version uses seed_based_connectivity_parallel.py for ~4x faster processing
# Expected runtime: 3-4 hours (vs 13-17 hours sequential)
#
...
# Parallelization settings (safe for 8 cores, 15GB RAM)
N_JOBS=${N_JOBS:-4}
BACKEND=${BACKEND:-loky}
VERBOSE=${VERBOSE:-10}

echo "================================================================================"
echo "CONTINUING CONNECTIVITY ANALYSIS FROM STEP 3 (PARALLEL VERSION)"
echo "================================================================================"
echo ""
...
# =============================================================================
# STEP 3: SEED-BASED CONNECTIVITY (Subject-Level) - PARALLEL
# =============================================================================

echo "STEP 3: Seed-Based Connectivity (PARALLEL)"
echo "--------------------------------------------------------------------------------"
