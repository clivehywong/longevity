#!/bin/bash
#SBATCH --job-name=xcpd_fcgsr_v2
#SBATCH --partition=shared_cpu
#SBATCH --cpus-per-task=8
#SBATCH --mem=32G
#SBATCH --time=24:00:00
#SBATCH --output=/home/clivewong/proj/long/logs/xcpd_fc_gsr_v2_%j.out
#SBATCH --error=/home/clivewong/proj/long/logs/xcpd_fc_gsr_v2_%j.err
...
mkdir -p /home/clivewong/proj/long/logs /home/clivewong/proj/long/work/xcpd/fc_gsr
echo "====== XCP-D FC+GSR | Job: ${SLURM_JOB_ID} | Node: $(hostname) | Start: $(date) ======"
...
singularity run \
  ...
  /home/clivewong/proj/long/derivatives/preprocessing/xcpd/fc_gsr \
  participant --mode linc -p 36P --dummy-scans auto -f 0.3 --min-time 240 \
  ...
  -w /home/clivewong/proj/long/work/xcpd/fc_gsr \
...
EXIT_CODE=$?
echo "====== XCP-D FC+GSR done | Exit: ${EXIT_CODE} | End: $(date) ======"

echo "Cleaning work directory..."
rm -rf /home/clivewong/proj/long/work/xcpd/fc_gsr/
