#!/bin/bash
#SBATCH --job-name=xcpd_ec_v2
#SBATCH --partition=shared_cpu
#SBATCH --cpus-per-task=8
#SBATCH --mem=32G
#SBATCH --time=24:00:00
#SBATCH --output=/home/clivewong/proj/long/logs/xcpd_ec_v2_%j.out
#SBATCH --error=/home/clivewong/proj/long/logs/xcpd_ec_v2_%j.err
...
mkdir -p /home/clivewong/proj/long/logs /home/clivewong/proj/long/work/xcpd/ec
echo "====== XCP-D EC | Job: ${SLURM_JOB_ID} | Node: $(hostname) | Start: $(date) ======"
...
singularity run \
  ...
  /home/clivewong/proj/long/derivatives/preprocessing/xcpd/ec \
  participant --mode linc -p acompcor --dummy-scans auto -f 0.5 --min-time 300 \
  --motion-filter-type notch --band-stop-min 12 --band-stop-max 18 \
  --smoothing 0.0 --head-radius auto --min-coverage 0.5 \
  ...
  -w /home/clivewong/proj/long/work/xcpd/ec \
  --despike --lower-bpf 0.01 --upper-bpf 0.10 \
  ...
  --participant-label 033 034 035 036 037 038 039 040 043 045 046 047 048 051 052 055 056 057 058 059 060 061 062 063 064 065 069 071 074 076 079 080 081 \
  --session-id 01 02

EXIT_CODE=$?
echo "====== XCP-D EC done | Exit: ${EXIT_CODE} | End: $(date) ======"

echo "Cleaning work directory..."
rm -rf /home/clivewong/proj/long/work/xcpd/ec/
